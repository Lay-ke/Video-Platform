...
router.get('/stream', authController.stream_get);
...
router.get('/admin-home', authController.admin_home_get); //add requireauth
router.get('/admin/logout', authController.admin_logout_get)
router.get('/logout', authController.logout_get);
router.get('/video', authController.video_get);
